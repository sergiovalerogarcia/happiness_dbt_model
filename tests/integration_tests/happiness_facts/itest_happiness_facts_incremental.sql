{{
  config(
    ...
    enabled=var('incremental_tests', 'false') == 'true'
    )
}}
...
{% set list_values = [
    ...
    [2021,'6f781c6559a0c605da918096bdb69edf', 7.808700085,1.285189509, 1.499525905, 0.961271405,               0.66231674,                     0.159670442, 0.477857262,               2.762835026,],
    [2021,'424214945ba5615eca039bfe5d731c09', 7.645599842,1.326948524, 1.503449202, 0.979332566,               0.665039897,                    0.242793396, 0.495260328,               2.432740688,],
    [2021,'3ad08396dc5afa78f34f548eea3c1d64', 7.559899807,1.39077425,  1.472403407, 1.040533185,               0.62895447,                     0.269055754, 0.407945901,               2.35026741,],
] %}
